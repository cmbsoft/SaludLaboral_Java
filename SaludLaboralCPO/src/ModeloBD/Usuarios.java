...
public class Usuarios {
    ...
    public Usuarios(int CODIGO_OPE, String Nombre, String clave, int JERARQUIA, String comentario, String alias, String DS_SUB_JERARQUIA, String dni, String TypeUser) {
